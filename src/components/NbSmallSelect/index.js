...
export default function NbSmallSelect(props){
  ...
  return (
      <Select {...rest} dropdownMatchSelectWidth={true} listHeight={lineHeight * 5} className="nb-small" dropdownClassName={
        classnames({
          "nb-small":true,
          "check-select":check
        })
      } suffixIcon={<CaretDownOutlined />} placeholder={placeholder ? placeholder : '请选择'} size={'small'}>
        {
